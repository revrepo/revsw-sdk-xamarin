...
namespace HttpClientSample
{
	public class NetHttp
	{
		...
		{
			var client = new HttpClient(new LoggingHandler(new HttpClientHandler()));//new HttpClient ();
			...
			ad.RenderStream (await client.GetStreamAsync (secure ? "https://gmail.com" : "http://www.e1.ru"));
		}
	}
}
